...
func TestPatchAlias_TableName(t *testing.T) {
	assert.Equal(t, "patch_alias", model.PatchAlias{}.TableName())
}

func TestPatchTag_TableName(t *testing.T) {
	assert.Equal(t, "patch_tag", model.PatchTag{}.TableName())
}
